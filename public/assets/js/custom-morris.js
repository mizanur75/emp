(function ($) {
  ...
  var lineMorris = new Morris.Line({
    ...
    resize: true,
    data: [
      { y: '2016 Q1', Attendances: 20 },
      { y: '2016 Q2', Attendances: 15 },
      { y: '2016 Q3', Attendances: 34 },
      { y: '2016 Q4', Attendances: 7 },
      { y: '2017 Q1', Attendances: 31 },
      { y: '2017 Q2', Attendances: 18 },
      { y: '2017 Q3', Attendances: 70 },
      { y: '2017 Q4', Attendances: 32 },
      { y: '2018 Q1', Attendances: 15 },
      { y: '2018 Q2', Attendances: 53 }
    ],
    xkey: 'y',
    ykeys: ['Attendances'],
    labels: ['Attendances'],
