				...
				<table id="tableId" class="table table-sm table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a href="{{route('admin.employee.show',$user->id)}}" class="btn btn-padding btn-sm btn-info"><i class="fa fa-eye"></i></a>
								<a href="{{route('admin.employee.edit',$user->id)}}" class="btn btn-padding btn-sm btn-primary"><i class="fa fa-edit"></i></a>
